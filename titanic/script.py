...
titanic_test = pandas.read_csv("C:\\Users\\sdahnke\\Dropbox\\Kaggle\\TitanicMachineLearningFromDisaster\\test.csv")
...
alg1 = RandomForestClassifier(random_state=1, n_estimators=10, min_samples_split=2, min_samples_leaf=1)
